...
a = st.number_input(' 목적없는 사용 ', value=0)      #초기값은 0
b = st.number_input(' 방해 ', value=0 )     # 초기값은 0.0
c = st.number_input(' 의존도 ', value=0 )
d = st.number_input(' 비교 ', value=0 )
e = st.number_input(' 확인빈도 ', value=0 )
f = st.number_input(' 우울 ', value=0 )
                                                            # 사용자가  0,1 중에 선택
